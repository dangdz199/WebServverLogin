...
<body>
	<div id="registration-form">
		<div class='fieldset'>
			<legend>DPS Admin Manager</legend>
			<form action="" method="post" data-validate="parsley">
				<div class='row'>
					<!--	<label for='firstname'>Username</label> -->
					<input type="text" placeholder="Username" value="<?php echo uniqid('DPS_') ?>" name='firstname' id='firstname' data-required="true" data-error-message="UserNnme is required" required>
				</div>
				<div class='row'>
					<!--	<label for="lastname">Password</label> -->
					<input type="text" placeholder="Password" value="<?php echo generateRandomString(8); ?>" name='lastname' data-required="true" data-type="email" data-error-message="Password is required" required>
				</div>
				<div class='row'>
	...
	<div class='sair'>
		<a href="logout.php"> <button type='button' class='btn btn-danger'>Close</button></a>
	</div>
	...
	<div class="container">
		<h2>Users</h2>
		<p>These are all the users registered in our database:</p>
			...
			<tbody>
				...
				while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) { ?>
					<tr>
						...
						<?php {
							echo "<td> <a href='mrz.php?no=" . $row['Username'] . "'><button type='button' class='btn btn-danger'>Remove</button></a> </td>";
						}
